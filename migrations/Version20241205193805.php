 ...
 */
final class Version20241205193805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id SERIAL NOT NULL, home_team_id INT NOT NULL, away_team_id INT DEFAULT NULL, number INT NOT NULL, home_score INT NOT NULL, away_score INT NOT NULL, PRIMARY KEY(id))');
